...
export function HeroSection({ logoSrc, bannerSrc }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden max-[400px]:pt-4 pt-6 pb-2 sm:pt-[clamp(28px,4.6vw,82px)] sm:pb-[clamp(18px,2.2vw,34px)]">
      <div className="mx-auto w-full">
        ...
        <div className="relative max-sm:-mt-6">
          ...
          <div className="absolute top-[55%] max-[400px]:left-[65%] left-[65%] lg:left-[62%] -translate-x-1/2 -translate-y-1/2 text-center">
            ...
            <p className="text-[#949494] font-amx-medium max-[400px]:text-[12px] text-[15px] sm:text-[24px] md:text-[27px] lg:text-[32px] xl:text-[41px] 2xl:text-[50px] leading-none">con todo lo que necesitás</p>
          </div>
        </div>
      </div>
    </section>
