      ...
      <div className="relative mx-auto  w-full lg:max-w-[900px] ">
        ...
        <div className="absolute flex flex-col  justify-between gap-4 w-[65%] left-1/2 -translate-x-[60%] top-[47%] lg:top-[44%] lg:translate-y-[-50%] -translate-y-1/2">
          <div className="flex items-center justify-center top-0 gap-6 lg:gap-8 mb-3">
            <div className="max-[400px]:w-10 w-12 sm:w-[64px] md:w-[80px] ">
              <Image
            ...
            <div className="uppercase text-[#de271f] lg:mt-8">
              <h1 className="font-amx-black max-[415px]:text-[22px] text-[28px] sm:text-[58px] leading-none  md:leading-11 tracking-tighter">
          ...
          <div className="grid grid-cols-2 gap-x-[30%] lg:gap-x-[40%] max-[415px]:gap-y-1 gap-y-[clamp(24px,0,46px)] top">
            {steps.map((step, index) => (
              ...
              >
                ...
                <span className="font-amx-regular max-[415px]:text-[16px] text-[clamp(18px,4vw,35px)] tracking-[-1px] leading-0 md:leading-12 text-cp-description">
                  {step}
                </span>
              </div>
            ))}
