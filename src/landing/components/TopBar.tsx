...
export function TopBar({ content }: TopBarProps) {
  return (
    <header className="pt-2 pb-1  2xl:pt-6 2xl:pb-3 w-full bg-[#231f20]">
      <nav
        ...
        {content.items.map((item, index) =>
          item.href === "#" ? (
            <span
              ...
              className="inline-flex items-center font-amx-regular text-[8px] sm:text-[11px] uppercase leading-none tracking-[0.08em] text-[#ffffff]"
            >
              {index > 0 ? (
